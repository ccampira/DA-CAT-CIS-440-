...
# Page 4
# page_four = Frame(window, bg='tan', width=1920, height=1080, borderwidth=1)
...
#contact button
contact_button = Button(bg_label, command=contact, font=('Impact', 20), text='Contact',
                       relief=GROOVE, bg='black', fg='white')
