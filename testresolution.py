...
# PAGE 3
page_three = Frame(window, bg='light blue', width=1280, height=800, borderwidth=2)
...
############################################################################################################ PAGE 2
page_two = Frame(window, bg='black', width=1280, height=800, borderwidth=1)
...
############################################################################################################ PAGE 3
page_three = Frame(window, bg='black', width=1280, height=800, borderwidth=1)
# Next button
